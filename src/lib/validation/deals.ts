...
export const createDealSchema = z.object({
  ...
  expectedCloseDate: z.string().refine((s) => !isNaN(Date.parse(s)), 'Data non valida').optional(),
...
export const updateDealSchema = z.object({
  ...
  expectedCloseDate: z.string().refine((s) => !isNaN(Date.parse(s)), 'Data non valida').optional().nullable(),
  actualCloseDate: z.string().refine((s) => !isNaN(Date.parse(s)), 'Data non valida').optional().nullable(),
