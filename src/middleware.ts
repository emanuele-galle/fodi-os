...
function setSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https://apis.google.com https://accounts.google.com; frame-src 'self' https://meet.google.com https://accounts.google.com; worker-src 'self';")
  return response
}
