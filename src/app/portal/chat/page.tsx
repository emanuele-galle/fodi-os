      ...
      <div className="shrink-0 border-t border-border p-3">
        <form onSubmit={handleSend} className="flex items-end gap-2">
          ...
          <textarea
            ...
            rows={1}
            className="flex-1 rounded-md border border-border bg-transparent px-3 py-2 text-sm placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 resize-none overflow-hidden"
            onKeyDown={(e) => {
