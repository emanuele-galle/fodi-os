...
const DEFAULT_WORKSPACES = [
  ...
  { name: 'Tecnico', slug: 'tecnico', description: 'Workspace per progetti tecnici', color: '#0A84FF', icon: 'wrench', sortOrder: 3 },
  { name: 'Clienti', slug: 'clienti', description: 'Workspace predefinito per progetti clienti', color: '#007AFF', icon: 'users', sortOrder: 4 },
]
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[workspaces/seed]', e)
