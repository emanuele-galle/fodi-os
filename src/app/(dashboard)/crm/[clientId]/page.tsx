...
import {
  ...
  CheckSquare, TrendingUp, Paperclip, Clock, Upload, ExternalLink, AlertCircle, Receipt
} from 'lucide-react'
...
/* ============ CLIENT FINANCES TAB ============ */
function ClientFinancesTab({ clientId, quotes }: { clientId: string; quotes: ClientQuote[] }) {
...
/* ============ CLIENT SIGNATURES TAB ============ */
function ClientSignaturesTab({ clientId }: { clientId: string }) {
  const router = useRouter()
...
/* ============ CLIENT EXPENSES TAB ============ */
function ClientExpensesTab({ clientId }: { clientId: string }) {
