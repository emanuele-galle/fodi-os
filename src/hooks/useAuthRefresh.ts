 ...
 *
 * Access token: 15m. Proactive refresh: every 12m.
 * On tab focus: refresh if last refresh was more than 5m ago.
 */
...
export function useAuthRefresh() {
  ...
  useEffect(() => {
    ...
    // Proactive refresh: every 12 minutes (3 min before 15m token expiry)
